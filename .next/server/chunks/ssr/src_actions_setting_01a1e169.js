module.exports=[19347,a=>a.a(async(b,c)=>{try{var d=a.i(37936),e=a.i(66680),f=a.i(12714),g=a.i(50227),h=a.i(18558),i=a.i(41154),j=a.i(976),k=a.i(13095),l=b([i]);[i]=l.then?(await l)():l;let J="/uploads/settings/",K=g.default.join(process.cwd(),"public","uploads","settings");function m(a){if(!a)return{};if("object"==typeof a)return a;try{return JSON.parse(a)}catch{return{}}}function n(a){var b;return{id:Number(a.id),page_key:a.page_key,page_path:a.page_path,meta_title:a.meta_title,meta_description:a.meta_description,meta_keywords:(b=a.meta_keywords,Array.isArray(b)?b:[]),canonical_url:a.canonical_url||"",robots_index:!!a.robots_index,robots_follow:!!a.robots_follow,og_title:a.og_title||"",og_description:a.og_description||"",og_image_url:a.og_image_url||"",og_type:a.og_type||"website",twitter_card:a.twitter_card||"summary_large_image",twitter_title:a.twitter_title||"",twitter_description:a.twitter_description||"",twitter_image_url:a.twitter_image_url||"",updated_at:a.updated_at}}function o(a){return{id:Number(a.id),provider:a.provider,display_name:a.display_name,environment:a.environment,is_active:!!a.is_active,public_key:a.public_key||"",secret_key:a.secret_key||"",merchant_id:a.merchant_id||"",endpoint_url:a.endpoint_url||"",additional_config:m(a.additional_config),last_tested_at:a.last_tested_at,updated_at:a.updated_at}}function p(a){return{id:Number(a.id),brand_name:a.brand_name||"",logo_url:(0,j.resolveAssetUrl)(a.logo_url),sort_order:Number(a.sort_order||0),is_active:!!a.is_active}}function q(a){return{id:Number(a.id),question:a.question||"",answer:a.answer||"",sort_order:Number(a.sort_order||0),is_active:!!a.is_active,updated_at:a.updated_at}}function r(a){return{id:Number(a.id),client_name:a.client_name||"",title:a.title||"",quote:a.quote||"",link_url:a.link_url||"",rating:Number(a.rating||5),sort_order:Number(a.sort_order||0),is_active:!!a.is_active,updated_at:a.updated_at}}function s(a,b=!1){if(null==a)return b;let c=String(a).toLowerCase();return"1"===c||"true"===c||"on"===c}function t(a,b=0){let c=Number.parseInt(String(a??""),10);return Number.isInteger(c)?c:b}async function u(a){let b=function(a){if(!("string"==typeof a&&(a.startsWith(J)||a.startsWith("/public/uploads/settings/"))))return null;let b=a.replace(/^\/public\//i,"").replace(/^\//,"");return g.default.join(process.cwd(),"public",b)}(a);if(b)try{await f.default.unlink(b)}catch(a){if(a?.code!=="ENOENT")throw a}}async function v(a){if(!(a instanceof File)||0===a.size)return null;if(!a.type?.startsWith("image/"))throw Error("File harus berupa gambar.");if(a.size>5242880)throw Error("Ukuran file melebihi 5MB.");await f.default.mkdir(K,{recursive:!0});let b=function(a=""){let b=g.default.extname(a).toLowerCase();return b&&b.replace(/[^.a-z0-9]/g,"")||".png"}(a.name),c=`${Date.now()}-${e.default.randomUUID()}${b}`,d=g.default.join(K,c),h=Buffer.from(await a.arrayBuffer());return await f.default.writeFile(d,h),`${J}${c}`}function w(){(0,h.revalidatePath)("/admin/setting"),(0,h.revalidatePath)("/"),(0,h.revalidatePath)("/merchandise"),(0,h.revalidatePath)("/robots.txt"),(0,h.revalidatePath)("/sitemap.xml")}function x(){(0,h.revalidatePath)("/"),(0,h.revalidatePath)("/admin/setting"),(0,h.revalidatePath)("/robots.txt"),(0,h.revalidatePath)("/sitemap.xml")}async function y(){let a=(await (0,i.query)(`SELECT
     ...
     LIMIT 1`)).rows[0]||{};return{site_name:a.site_name||"X-ALT",app_url:a.app_url||"",logo_url:(0,j.resolveAssetUrl)(a.logo_url),favicon_url:(0,j.resolveAssetUrl)(a.favicon_url),og_image_url:(0,j.resolveAssetUrl)(a.og_image_url),site_tagline:a.site_tagline||"",hero_title:a.hero_title||"",hero_description:a.hero_description||"",hero_note:a.hero_note||"",hero_image_url:(0,j.resolveAssetUrl)(a.hero_image_url),hero_badge_title:a.hero_badge_title||"",hero_badge_text:a.hero_badge_text||"",whatsapp_number:a.whatsapp_number||"",support_email:a.support_email||"",instagram_url:a.instagram_url||"",linkedin_url:a.linkedin_url||""}}async function z(a){if(!a)return null;try{let b=(await (0,i.query)(`SELECT
       ...
       WHERE page_key = $1
       LIMIT 1`,[a])).rows[0];return b?n(b):null}catch{return null}}async function A(){return(await (0,i.query)(`SELECT
       id,
       brand_name,
       logo_url,
       sort_order,
     ...
     ORDER BY sort_order ASC, id ASC`)).rows.map(p)}async function B(){var a,b;let[c,d,e,f,g,h,k]=await Promise.all([(0,i.query)(`SELECT
           id,
           site_name,
           site_tagline,
           app_url,
       ...
       SET brand_name = $1,
           ...
           is_active = $4,
           updated_at = NOW()
       WHERE id = $5`,[d,j,e<0?0:e,f,c]),b&&j!==b&&await u(b),x(),{ok:!0,message:"Logo trusted company berhasil diperbarui."}}catch(a){for(let a of h)await u(a);return{ok:!1,message:a?.message||"Gagal memperbarui logo."}}}async function F(a,b){let c=t(b.get("trusted_logo_id"),0);if(!Number.isInteger(c)||c<=0)return{ok:!1,message:"ID logo tidak valid."};try{let a=await (0,i.query)(`SELECT logo_url
       FROM content.trusted_logos
       WHERE id = $1
       ...
       WHERE id = $1`,[c]),b&&await u(b),x(),{ok:!0,message:"Logo trusted company berhasil dihapus."}}catch(a){return{ok:!1,message:a?.message||"Gagal menghapus logo."}}}async function G(a,b){let c=t(b.get("id"),0),d=String(b.get("page_path")||"").trim(),e=String(b.get("meta_title")||"").trim(),f=String(b.get("meta_description")||"").trim(),g=String(b.get("meta_keywords")||""),j=String(b.get("canonical_url")||"").trim(),k=s(b.get("robots_index"),!1),l=s(b.get("robots_follow"),!1),m=String(b.get("og_title")||"").trim(),n=String(b.get("og_description")||"").trim(),o=String(b.get("og_image_url")||"").trim(),p=String(b.get("og_type")||"website").trim(),q=String(b.get("twitter_card")||"summary_large_image").trim(),r=String(b.get("twitter_title")||"").trim(),u=String(b.get("twitter_description")||"").trim(),v=String(b.get("twitter_image_url")||"").trim();if(!Number.isInteger(c)||c<=0)return{ok:!1,message:"ID SEO tidak valid."};if(!d||!e||!f)return{ok:!1,message:"Path, meta title, dan meta description wajib diisi."};try{return await (0,i.query)(`UPDATE settings.seo_metadata
       SET page_path = $1,
           meta_title = $2,
           meta_description = $3,
       ...
       SET provider = $1,
           ...
           is_active = $11,
           updated_at = NOW()
       WHERE id = 1`,[c,d,e,"ssl"===f,f,g||null,h||null,j,k,l||null,m]),w(),{ok:!0,message:"SMTP config berhasil diperbarui."}}catch(a){return{ok:!1,message:a?.message||"Gagal memperbarui SMTP config."}}}(0,k.ensureServerEntryExports)([y,z,A,B,C,D,E,F,G,H,I]),(0,d.registerServerReference)(y,"006118eb6db80d3f8dc7f452e39a3b1aba51309b1b",null),(0,d.registerServerReference)(z,"405301a48dc15a945be44dc4f82d5f07bf44bd8f46",null),(0,d.registerServerReference)(A,"00dd8ef374a8364abba2b76d7c389c982cd02973cf",null),(0,d.registerServerReference)(B,"00d3eea315d89e6dc617099e9c6ec216260f3fea7f",null),(0,d.registerServerReference)(C,"6099eec332da78f215f9ff34864f03a56f4bbe93af",null),(0,d.registerServerReference)(D,"605ed5dd78269040e16dcc378b7e26d2c7e1c6ceb5",null),(0,d.registerServerReference)(E,"60e9249f1a139fcfd50363bc1480e22c59f9231e83",null),(0,d.registerServerReference)(F,"600dcbd5d70f6363868a9e798c11f0fe481ebf0abe",null),(0,d.registerServerReference)(G,"60b37f152ebaa9b34b582d2eb4ceafdf0474ba00da",null),(0,d.registerServerReference)(H,"607a873ff07092ecbffc6f2640d492250625e4e05e",null),(0,d.registerServerReference)(I,"60879e4c74f1ee1234e9b96efaab9d8d79787f20a9",null),a.s(["addTrustedLogoAction",()=>D,"deleteTrustedLogoAction",()=>F,"getAdminSettingsData",()=>B,"getSeoMetadataByPageKey",()=>z,"getTrustedLogos",()=>A,"getWebsiteBranding",()=>y,"updateApiIntegrationAction",()=>H,"updateSeoMetadataAction",()=>G,"updateSmtpConfigAction",()=>I,"updateTrustedLogoAction",()=>E,"updateWebsiteConfigAction",()=>C]),c()}catch(a){c(a)}},!1)];
